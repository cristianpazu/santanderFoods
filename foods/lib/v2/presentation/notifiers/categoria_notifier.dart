...
import 'package:foods/v2/presentation/notifiers/categoria_state.dart';
import 'package:foods/v2/presentation/providers/categoria_repository_providers.dart';

final categoriaProvider = StateNotifierProvider<CategoriaNotifier, CategoriaState>((ref){
...
class CategoriaNotifier extends StateNotifier<CategoriaState>{
  ...
  CategoriaNotifier({required this.categoriarepositories}): super(CategoriaState()){
    loadCategoria();
